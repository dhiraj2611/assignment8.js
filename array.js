...
//Ans.    let studentRecords2 = 
        [ 
            {name: 'dhiraj', class: 10, Rollno : 25 },
            {name: 'karan', class: 8, Rollno : 23 },
            {name: 'bray', class: 12, Rollno : 45 },
            {name: 'paul', class: 11, Rollno : 55 }, 
            {name: 'jack', class: 7, Rollno : 21 },
            {name: 'venica', class: 9, Rollno : 14 } 
        ];